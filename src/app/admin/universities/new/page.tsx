  ...
  return (
    <div className="max-w-2xl space-y-5">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Add University</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400">Create a new university record</p>
        </div>
      </div>
