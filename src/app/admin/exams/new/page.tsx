...
export default function NewExam() {
  ...
  const [form, setForm] = useState({ title: "", university_id: "", department_id: "", year: new Date().getFullYear(), pages: 0, file_url: "", is_published: true });
  ...
  return (
    <div className="max-w-2xl space-y-5">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Add Exam</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400">Upload a new exam paper</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 p-6 space-y-5">
        ...
        <div className="space-y-1.5">
          ...
          <input type="text" required placeholder="Computer Science Exit Exam" value={form.title}
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-1.5">
            ...
            <input type="number" required min={2000} max={2099} value={form.year}
